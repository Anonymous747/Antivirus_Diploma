    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            MLModel1.ModelInput sampleData = new MLModel1.ModelInput()
            {
                ...
                SectionsNb = 4F,
                SectionsMeanRawsize = 35584F,
                SectionsMinRawsize = 2048F,
                SectionMaxRawsize = 130560F,
                SectionsMeanVirtualsize = 37322F,
            ...
            Console.WriteLine($"SectionsMeanRawsize: {35584F}");
            Console.WriteLine($"SectionsMinRawsize: {2048F}");
            Console.WriteLine($"SectionMaxRawsize: {130560F}");
            Console.WriteLine($"SectionsMeanVirtualsize: {37322F}");
            ...
            Console.WriteLine($"ResourcesMeanSize: {837F}");
            ...
            Console.WriteLine($"Legitimate: {1F}");
